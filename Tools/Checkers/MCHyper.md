...
- *Circuit*: [[Verilog]] module or [[Aiger]] circuit
- *HyperLTL formula*: [[EAHyper]] or [[MCHyper]] (own) format
...
It uses [[ABC]] as the backend for checking the reachability of a violation.
